        ...
        <>
            <nav className="navbar navbar-expand-md fixed-top navbar-dark bg-primary">
                ...
                <div className="cursor">
                       ...
                       <img src="https://static.thenounproject.com/png/70771-200.png" width='40' onClick={getcart} />
                        </div>
                        <div className="drobdown">
                        <div className="profile ">
                        <h5 onClick={()=>navigate('/profile',{state:state.result})}>{localStorage.getItem('name')}</h5>
