...
// const Cart = () =>{
//     const item = useSelector((state)=>state.cart[0])
...
const changeAddress= () =>{
    ...
    axios.put(`http://localhost:8080/user/updateAdd`,info).then(result=>{
